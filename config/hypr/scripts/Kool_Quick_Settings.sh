...
rainbow_borders_menu() {
    ...
    local choice
    choice=$(printf "%b" "$options" | rofi_menu_pick "Rainbow Borders: $current_display" "$rofi_theme")
...
main() {
    choice=$(menu | rofi_menu_pick "$msg" "$rofi_theme")
    ...
    case "$choice" in
        ...
        "Choose Fuzzel Theme") $scriptsDir/FuzzelStyle.sh ;;
