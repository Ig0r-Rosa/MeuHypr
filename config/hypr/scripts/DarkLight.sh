...
# intial kill process (não usar SIGUSR1 na waybar — isso oculta a barra)
for pid in fuzzel swaync ags swaybg; do
...
sleep 2
# kill process
for pid1 in waybar fuzzel swaync ags swaybg; do
    killall "$pid1"
done
